...
export const HERO_CONTENT = `I am a Full Stack Developer with a Mechatronics background with a strong interest Web Development, Fintech, AI, and cutting-edge technology. Through diverse experiences in the fields of materials, manufacturing, automotive and design, I have gained valuable insights and broadened my horizons. My focus has shifted to software development, where I have honed my skills in various programming languages and frameworks. With a goal of continuous improvement, I stay updated on the latest technologies and best practices. Effective communication and teamwork are integral parts of my work approach, while my hobbies in CAD design, 3D printing, laser engraving, and electronics foster my creativity. I am excited to start a career in software development and take on new challenges.`;

export const ABOUT_TEXT = `As an accomplished full-stack developer, I've honed a diverse skill set spanning a wide range of cutting-edge technologies, including React, Angular, Vue, Node.js, MongoDB, Express, Python, Django, PostgreSQL, AWS Lambda, and Docker, among others. What initially ignited my passion for web development was a deep fascination with how digital systems work, and this curiosity has evolved into a relentless drive to tackle complex challenges and deliver exceptional solutions. Thriving in collaborative environments, I excel at effective communication, attention to detail, and a commitment to excellence that permeates every aspect of my work. Beyond just coding, I pursue a balanced lifestyle through physical activity and personal growth, all of which fuel my enthusiasm to make a lasting impact in the ever-evolving tech landscape!`;
...
export const PROJECTS = [
  ...
  },
 {
    ...
    image: project6,
    description:
      "Meet is an application designed to display events filtered by city using the Google Calendar API. It incorporates user authorization tokens and credentials managed through AWS Lambda, ensuring secure access to calendar data. The app provides a streamlined interface for users to browse and manage events based on their location, leveraging serverless architecture for efficient data handling and retrieval.",
